...
namespace ToDoList.ViewModel
{
    ...
    {
        private TaskMongoDBService _service;
        ...
        {
            var tasks = await _service.GetTasksCollection(x);

            foreach (var taskModel in tasks)
            {
                //should probably supress the notifications and all tasks in bulk.... meh, whatever
